...
public class Product extends TableImpl<ProductRecord> {
    ...
    /**
     * The column <code>public.product.company_name</code>.
     */
    public final TableField<ProductRecord, String> COMPANY_NAME = createField(DSL.name("company_name"), SQLDataType.VARCHAR.nullable(false), this, "");
