...
insert into organisations(tax_number, name, checking_account) VALUES
...
insert into receipts (creation_date, organisation_tax_number) VALUES
('2022-11-11',21632632),
('2022-11-12',16041604),
('2022-11-13',43632466),
('2022-11-14',26636366),
...
insert into receipt_items(receipt_id, product_code, price, amount) VALUES
(1,1,20,40),
(1,2,30,30),
(2,2,40,40),
(2,3,50,50),
