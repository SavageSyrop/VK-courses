...
public class OrganisationRecord extends UpdatableRecordImpl<OrganisationRecord> implements Record3<Long, String, Long> {
    ...
    /**
     * Setter for <code>public.organisation.tax_number</code>.
     */
    public OrganisationRecord setTaxNumber(Long value) {
        set(0, value);
        return this;
    }
     ...
     */
    public OrganisationRecord setCheckingAccount(Long value) {
        set(2, value);
        return this;
    }
    ...
    public Field<Long> field1() {
        return Organisation.ORGANISATION.TAX_NUMBER;
    }
     ...
     */
    public OrganisationRecord(Long taxNumber, String name, Long checkingAccount) {
        super(Organisation.ORGANISATION);
     ...
     * Create a detached, initialised OrganisationRecord
     */
    public OrganisationRecord(generatedEntities.tables.pojos.Organisation value) {
        super(Organisation.ORGANISATION);
